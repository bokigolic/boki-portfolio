...
const FoodDashAPP = (props) => {
  return (
    <ProjectItem>

      <div className="project-title" id="FoodDashAPP">Food Dash</div>
      <div className="project-overview"><div className="left">
        <div className="project-img-container">
          <img src={staticFolder() + "/img/anaolson.jpg"} alt="" />
        </div>
        <div className="project-buttons">
          <a target="_blank" href="https://github.com/mpompilio/FoodDashAPP" rel="noreferrer">GitHub</a>
