      ...
      <div className="project-overview">
        <div className="right">
          <div className="project-img-container">
            <img className='image-city' src={staticFolder() + "/imgcity/talija.png"} alt="talija" />
          </div>
        ...
        <div className="left">
          ...
          <div className="project-description">
            <h3 className="project-subtitle">Description: Advertising <br/></h3><br/>
